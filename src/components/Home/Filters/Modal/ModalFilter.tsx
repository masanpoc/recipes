...
createPortal(<StyledMobileModalDiv>
     ...
     <StyledWrapperModal>
      <StyledMobileTitleDiv> 
          <StyledClearButton type='button' onClick={ ()=>formCntxt.dispatch({type: "CLEAR_FILTERS", value: {input: '', selected: [], checked: false, isActive: false}})}>Clear All</StyledClearButton>
