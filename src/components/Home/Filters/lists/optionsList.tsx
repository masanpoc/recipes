...
const optionsList: Filters[] = [
    ...
    {
        filter: 'health',
        options: ['vegetarian', 'vegan', 'dairy-free',  'red-meat-free', 'shellfish-free', 'wheat-free', 'soy-free']
    },
    {
        filter: 'cuisineType',
        options: ['French', 'Italian', 'Mediterranean', 'Eastern Europe', 'Central Europe', 'Nordic']
    },
    {
        filter: 'diet',
